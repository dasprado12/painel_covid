<template>
    <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <a class="navbar-brand logo-text page-scroll" href="index.html">SIMOP | UnB</a>
        <!-- Image Logo -->
        ...
        <div v-if="currentRoute != 'Dados' && currentRoute != 'Predicao'" class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#preview">DETALHES</a>
                </li>
                <!-- Dropdown Menu -->          
                <li class="nav-item dropdown"> 
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item" href="/#/previsao"><span class="item-text">PREVISÃO</span></a>
                    </div>
                </li> 
        ...
        <div v-else class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/#/">HOME <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/#/">SOBRE</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/#/">DETALHES</a>
                </li>
                <!-- Dropdown Menu -->          
                <li class="nav-item dropdown"> 
                ...
                <!-- end of dropdown menu -->
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="/#/">CONTATO</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    data(){
        return{
            pages: [
                ...
                { title: "Previsão", router: "/previsao", color: "green lighten-2" },
